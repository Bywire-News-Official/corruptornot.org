...
@Component({
  selector: 'app-result-least',
  templateUrl: './result-least.component.html',
  styleUrls: ['./result-least.component.css']
})
export class ResultLeastComponent implements OnInit {
